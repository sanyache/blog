...
urlpatterns = [
    ...
    url(r'^boards/(?P<pk>\d+)/topics/(?P<topic_pk>\d+)/edit/$', views.topic_edit, name='edit_topic'),
    url(r'^boards/(?P<pk>\d+)/topics/(?P<topic_pk>\d+)/topic_delete/$', views.topic_delete, name='topic_delete'),
    url(r'^boards/(?P<pk>\d+)/topics/(?P<topic_pk>\d+)/reply/$', views.reply_topic, name='reply_topic'),
    url(r'^boards/(?P<pk>\d+)/topics/(?P<topic_pk>\d+)/posts/(?P<post_pk>\d+)/reply_delete/$', views.reply_delete, name='reply_delete'),
    ...
    url(r'^reset/$',
        auth_views.PasswordResetView.as_view(template_name='password_reset.html', email_template_name='password_reset_email.html', subject_template_name='password_reset_subject.txt'), name='password_reset'),
